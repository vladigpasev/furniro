...
export class MailOffersController {
  ...
  @ApiResponse({ status: 201, description: 'Email successfully added to database and Mailchimp.' })
  ...
  @ApiResponse({ status: 200, description: 'Email successfully removed from database and Mailchimp.' })
