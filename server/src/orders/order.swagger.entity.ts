...
export class OrderSwagger {
  @ApiProperty({ description: 'Array of products with quantity and price', example: [{ product: '64e73458dfb1a820b5b47e07', quantity: 2, unit_price: 49.99 }] })
  products: Array<{
    product: string;
    quantity: number;
    unit_price: number;
  ...
  @ApiProperty({ description: 'Additional information', example: 'Leave at the front door', required: false })
